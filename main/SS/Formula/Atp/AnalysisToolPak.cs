...
namespace NPOI.SS.Formula.Atp
{
    ...
    public class AnalysisToolPak : UDFFinder
    {
        ...
        private static Dictionary<String, FreeRefFunction> CreateFunctionsMap()
        {
            ...
            r(m, "ACCRINT", AccrintFunction.instance);
            r(m, "ACCRINTM", AccrintMFunction.instance);
            r(m, "AMORDEGRC", AmorDegrcFunction.instance);
            r(m, "AMORLINC", AmorLincFunction.instance);
            ...
            r(m, "COUPDAYBS", CoupDayBsFunction.instance);
            r(m, "COUPDAYS", CoupDaysFunction.instance);
            r(m, "COUPDAYSNC", CoupDaysNcFunction.instance);
            r(m, "COUPNCD", CoupNcdFunction.instance);
            r(m, "COUPNUM", CoupNumFunction.instance);
            r(m, "COUPPCD", CoupPcdFunction.instance);
            ...
            r(m, "OCT2HEX", null);
            r(m, "ODDFPRICE", OddFPriceFunction.instance);
            r(m, "ODDFYIELD", OddFYieldFunction.instance);
            r(m, "ODDLPRICE", OddLPriceFunction.instance);
            r(m, "ODDLYIELD", OddLYieldFunction.instance);
            r(m, "PRICE", PriceFunction.instance);
            r(m, "PRICEDISC", PriceDiscFunction.instance);
            r(m, "PRICEMAT", PriceMatFunction.instance);
            ...
            r(m, "TBILLEQ", TBillEqFunction.instance);
            r(m, "TBILLPRICE", TBillPriceFunction.instance);
            ...
            r(m, "XIRR", XirrFunction.instance);
            r(m, "XLOOKUP", XLookupFunction.instance);
            r(m, "XMATCH", XMatchFunction.instance);
            r(m, "XNPV", XnpvFunction.instance);
            r(m, "YEARFRAC", YearFrac.instance);
            r(m, "YIELD", YieldFunction.instance);
            r(m, "YIELDDISC", YieldDiscFunction.instance);
            r(m, "YIELDMAT", YieldMatFunction.instance);
